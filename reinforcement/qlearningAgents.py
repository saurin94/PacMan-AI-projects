...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        learnedValue = self.alpha * (reward + (self.discount * self.getValue(nextState)) - self._qValues[(state,action)])
        self._qValues[(state,action)] = self._qValues[(state,action)] + learnedValue
